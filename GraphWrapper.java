...
/**
 * Wrapper class for creating a graph using input from two text files.
...
public class GraphWrapper {
    ...
    /**
     * Constructs a GraphWrapper object using input from the specified text files.
     *
     * @param test if true, prompts the user to enter the text file names and home and goal node coordinates
     */
	 ...
	 * Returns the home GraphNode.
	 *
	 * @return the home GraphNode
	 */
